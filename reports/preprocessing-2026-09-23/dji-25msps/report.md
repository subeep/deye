...
| --- | --- | --- | ---: | ---: | ---: |
| dji_mini2 | real / development | fail | 0 | 59.28 | 4.07 |

Failure: dji_mini2: Confirmed count 0 outside [8, 8]


Failure: dji_mini2: Missing protocols: DJI DroneID


Failure: dji_mini2: Unexpected protocols: DJI-like OFDM


Failure: dji_mini2: Confirmed models differ: []

| dji_mavic_air_2 | real / development | fail | 0 | 125.40 | 27.83 |
